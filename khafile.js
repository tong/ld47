...
project.addParameter('superposition.TestScene');
project.addParameter("--macro keep('superposition.TestScene')");
...
project.addAssets("Data/tex/MetalPlates004/MetalPlates004_2K_Displacement.jpg", { notinlist: true });
